function y = dct2blockwise(x, H, W)
% y = dct2blockwise(x, H, W)
% y = dct2blockwise(x, [H W])
% This function performs blockwise 2-D WxH DCT on the input array "x".
